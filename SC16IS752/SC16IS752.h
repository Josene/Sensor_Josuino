...
class SC16IS752 : public i2c_device
{
    public:
        SC16IS752();
		...
		uint8_t readUART(uint8_t RegAddr, uint8_t Channel);
		void writeUART_Array(uint8_t Channel, uint8_t Len, uint8_t *Data);
		uint8_t readUART_Array(uint8_t Channel, uint8_t *Data);
		void writeUART_charArray(uint8_t Channel, uint8_t Len, char *Data);
