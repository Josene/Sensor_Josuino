...
#define POWERWIFION				0x00020000
#define POWERWIFIOFF			0XFFFDFFFF
#define POWERLORAON				0x00040000
#define POWERLORAOFF			0XFFFBFFFF
#define POWERMIRAON				0x00080000
#define POWERMIRAOFF			0XFFF7FFFF
#define POWERCO2ON				0x00000800
#define POWERCO2OFF				0XFFFFF7FF
#define POWERPMON				0x00004000
#define POWERPMOFF				0XFFFFBFFF

#define TIMERMAX 				50
#define PUSH_MAX				0x41

#define SENSOR_ID				0x40
#define SENSOR_SESSIONTIMER		0x3F
#define SENSOR_TOTALUPTIMER		0x3E
#define SENSOR_CALTIMER			0x3D
#define SENSOR_POWERSTATE		0x3C
...
#define SENSOR_ACCELEROZ		0x2D
#define SENSOR_DEVICEANGLE		0x2C
...
class LEDRing
{
	public:
		...
		static void showPM10(uint8_t mode=0);
		static void showPM2_5(uint8_t mode=0);
		static void showCO2(uint8_t mode=0);
...
class Utils
{
	public:
		...
		static void disableLoRa();
		static int queryMiRa();
		static void enableMiRa();
		static void disableMiRa();
